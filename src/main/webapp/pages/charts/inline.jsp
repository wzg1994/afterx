                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="morris.jsp"><i class="fa fa-angle-double-right"></i> Morris</a></li>
                                <li><a href="flot.jsp"><i class="fa fa-angle-double-right"></i> Flot</a></li>
                                <li  class="active"><a href="inline.jsp"><i class="fa fa-angle-double-right"></i> Inline charts</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
