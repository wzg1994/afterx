                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="general.jsp"><i class="fa fa-angle-double-right"></i> General</a></li>
                                <li><a href="icons.jsp"><i class="fa fa-angle-double-right"></i> Icons</a></li>
                                <li class="active"><a href="buttons.jsp"><i class="fa fa-angle-double-right"></i> Buttons</a></li>
                                <li><a href="sliders.jsp"><i class="fa fa-angle-double-right"></i> Sliders</a></li>
                                <li><a href="timeline.jsp"><i class="fa fa-angle-double-right"></i> Timeline</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
