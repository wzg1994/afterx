                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="charts/morris.jsp"><i class="fa fa-angle-double-right"></i> Morris</a></li>
                                <li><a href="charts/flot.jsp"><i class="fa fa-angle-double-right"></i> Flot</a></li>
                                <li><a href="charts/inline.jsp"><i class="fa fa-angle-double-right"></i> Inline charts</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="UI/general.jsp"><i class="fa fa-angle-double-right"></i> General</a></li>
                                <li><a href="UI/icons.jsp"><i class="fa fa-angle-double-right"></i> Icons</a></li>
                                <li><a href="UI/buttons.jsp"><i class="fa fa-angle-double-right"></i> Buttons</a></li>
                                <li><a href="UI/sliders.jsp"><i class="fa fa-angle-double-right"></i> Sliders</a></li>
                                <li><a href="UI/timeline.jsp"><i class="fa fa-angle-double-right"></i> Timeline</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="forms/general.jsp"><i class="fa fa-angle-double-right"></i> General Elements</a></li>
                                <li><a href="forms/advanced.jsp"><i class="fa fa-angle-double-right"></i> Advanced Elements</a></li>
                                <li><a href="forms/editors.jsp"><i class="fa fa-angle-double-right"></i> Editors</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="tables/simple.jsp"><i class="fa fa-angle-double-right"></i> Simple tables</a></li>
                                <li><a href="tables/data.jsp"><i class="fa fa-angle-double-right"></i> Data tables</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="calendar.jsp">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="examples/invoice.jsp"><i class="fa fa-angle-double-right"></i> Invoice</a></li>
                                <li><a href="examples/login.jsp"><i class="fa fa-angle-double-right"></i> Login</a></li>
                                <li><a href="examples/register.jsp"><i class="fa fa-angle-double-right"></i> Register</a></li>
                                <li><a href="examples/lockscreen.jsp"><i class="fa fa-angle-double-right"></i> Lockscreen</a></li>
                                <li><a href="examples/404.jsp"><i class="fa fa-angle-double-right"></i> 404 Error</a></li>
                                <li><a href="examples/500.jsp"><i class="fa fa-angle-double-right"></i> 500 Error</a></li>
                                <li><a href="examples/blank.jsp"><i class="fa fa-angle-double-right"></i> Blank Page</a></li>
                            </ul>
                        </li>
                    </ul>
                </section>
