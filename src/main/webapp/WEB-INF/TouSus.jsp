...
<body>
      <input type="button"  value="一键删除评论" onclick="deDialog()">
      <center>
...
<table class="table" id="stu-tableA" border="1"></table>
    <script type="text/javascript" src="js/My97DatePicker/WdatePicker.js"></script>
    <script type="text/javascript">
    function search(){
        $("#stu-tableA").bootstrapTable("refresh",{'pageNumber':1});
    }

        $("#stu-tableA").bootstrapTable({
            url:"queryStuPage?xx=1",
            striped: true,//隔行变色
...
//	             return 的数据 是action类中的参数传递到
   ...
   function deDialog(){
      var  b=$("#stu-tableA").bootstrapTable('getSelections')
      var str=[];
      var jj=[];
          ...
          if (bbb) {
              $.post('deleteTouSu',{'qid':str,'qqid':jj},function(data){
                  ...
                  if (data == "0")
                      ...
                      $("#stu-tableA").bootstrapTable("refresh");
