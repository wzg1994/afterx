...
<div style="float:left">
    ...
    <table class="table" id="totopic_table2" border="1"></table>


<script>
    function search(){
        $("#totopic_table2").bootstrapTable("refresh",{'pageNumber':1});
    }
    $(function(){
        $("#totopic_table2").bootstrapTable({
            url:"/querywzjtotopic",
            striped: true,//隔行变色
    ...
    function todeletetotopic(topicid) {
        $.ajax({
            ...
            success:function(data){
                if (data>0) {
                    $("#totopic_table2").bootstrapTable("refresh");
                }
            }
        })
    }
...
function addDialogtotopic(){
    ...
    function todeletetotopic2(){
        var a=$("#totopic_table2").bootstrapTable("getSelections")
        var str="";
