...
<div style="float:left">
    ...
    <table class="table" id="totopic_table" border="1"></table>


<script>
    function search(){
        $("#totopic_table").bootstrapTable("refresh",{'pageNumber':1});
    }
    $(function(){
        $("#totopic_table").bootstrapTable({
            url:"/querywzjtotopic",
            striped: true,//隔行变色
    ...
    function todeletetotopic(topicid) {
        $.ajax({
            ...
            success:function(data){
                if (data>0) {
                    $("#totopic_table").bootstrapTable("refresh");
                }
            }
        })
    }
...
function addDialogtotopic(){
    ...
    function todeletetotopic2(){
        var a=$("#totopic_table").bootstrapTable("getSelections")
        var str="";
