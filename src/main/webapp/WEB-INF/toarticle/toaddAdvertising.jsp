...
<body>
    <form id="Advertising_add" method="post">
    广告主题：<input type="text" name="advertisingtitle"><br>
    广告内容：<textarea name="advertisingcontent"></textarea><br>
    广告图片：<input type="hidden" name="advertisingimg" id="aas">
        <div id="showBarDiv" ></div>
        <input type="File" id="imgFile" >
        <div id="showImgDivs1" style="width: 80px;height: 80px;border-style:solid;border-width:1px; border-color:black;"></div><br>
    状态：<input type="radio" name="advertisingcyn" value="1"/>已发布
        <input type="radio" name="advertisingcyn" value="2"/>未发布
    </form>
